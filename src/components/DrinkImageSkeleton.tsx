...
export function DrinkImageSkeleton() {
  return (
    <div className="relative h-96 bg-linear-to-br from-primary/5 to-primary/10 animate-pulse rounded-t-2xl overflow-hidden">
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <div className="p-6 bg-white/10 rounded-full backdrop-blur-xs mb-4">
